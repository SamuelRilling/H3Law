export function PageHeader({
  ...
  return (
    <section className="bg-primary-wash pt-36 pb-20 md:pt-44 md:pb-24">
      <div className="mx-auto max-w-3xl px-6 text-center md:px-10">
        ...
        {description && (
          <p className="mx-auto mt-5 max-w-xl text-balance text-base leading-relaxed text-primary-foreground/70">
            {description}
          </p>
        )}
      </div>
